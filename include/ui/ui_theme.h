...
namespace UITheme {
    ...
    static constexpr float XY_STEP_VALUES[] = {100.0f, 50.0f, 10.0f, 1.0f, 0.1f, 0.01f};
    static constexpr const char* XY_STEP_LABELS[] = {"100", "50", "10", "1", "0.1", "0.01"};
    static constexpr int XY_STEP_COUNT = 6;
    
    static constexpr float Z_STEP_VALUES[] = {50.0f, 25.0f, 10.0f, 1.0f, 0.1f, 0.01f};
    static constexpr const char* Z_STEP_LABELS[] = {"50", "25", "10", "1", "0.1", "0.01"};
    static constexpr int Z_STEP_COUNT = 6;
}
