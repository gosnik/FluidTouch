...
// [3]  flags (bit0=connected, bit1=has_wpos, bit2=has_mpos, bit3=encoder_enabled)
...
constexpr uint8_t kOutputStatusFlagConnected = 0x01;
constexpr uint8_t kOutputStatusFlagHasWpos = 0x02;
constexpr uint8_t kOutputStatusFlagHasMpos = 0x04;
constexpr uint8_t kOutputStatusFlagEncoderEnabled = 0x08;
