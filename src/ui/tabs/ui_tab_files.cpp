...
void UITabFiles::create(lv_obj_t *tab) {
    ...
    lv_obj_set_style_bg_color(storage_dropdown, UITheme::DROPDOWN_BG, 0);
    ...
    for(int i = 0; i < 8; i++) {
        ...
        lv_obj_set_style_bg_color(file_entry, UITheme::BG_MEDIUM, 0);
        lv_obj_set_style_border_color(file_entry, UITheme::FILE_ITEM_BORDER, 0);
        ...
        lv_obj_set_style_text_color(file_size, UITheme::FILE_SIZE_TEXT, 0);
